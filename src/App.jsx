...
class Blacklist extends React.Component {
  ...
  handleSubmit(e) {
    e.preventDefault();
    const form = document.forms.blacklistTravellerAdd;
    const passenger = {
  ...
  render() {
    return (
      <form name="blacklistTravellerAdd" onSubmit={this.handleSubmit}>
...
class TicketToRide extends React.Component {
  ...
  async deleteTraveller(passenger) {
     ...
     * - Make a call to graphQLFetch with two parameters: mutation query, {variable}
     * - Post process data and take some action (e.g., re-load UI)  */
    const travellername = passenger.name;
  ...
  async blacklistTraveller(passenger) {
    ...
    const query = `mutation blacklistTraveller($passenger: BlackTravellerInputs!) {
