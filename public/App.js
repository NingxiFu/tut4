...
var Blacklist = /*#__PURE__*/function (_React$Component3) {
  ...
  _createClass(Blacklist, [{
    ...
    value: function handleSubmit(e) {
      e.preventDefault();
      var form = document.forms.blacklistTravellerAdd;
      var passenger = {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              if (data) {
                this.setState({
                  travellers: data.listTravellers
                });
              }
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
               ...
               * - Post process data and take some action (e.g., re-load UI)  */
              query = "mutation addTraveller($passenger: InputTicket!) {\n      addTraveller(ticket: $passenger) {\n        id\n      }\n    }";
              _context2.next = 3;
              return graphQLFetch(query, {
                passenger: passenger
              });
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              query = "mutation deleteTraveller($travellername: String!) {\n      deleteTraveller(travellername: $travellername)\n    }";
              _context3.next = 4;
              return graphQLFetch(query, {
            ...
            case 4:
              data = _context3.sent;
              if (data.deleteTraveller) {
                this.loadData();
                alert("Deleted Successfully!");
              } else {
                alert("Sorry, Not found for delete!");
              }
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              query = "mutation blacklistTraveller($passenger: BlackTravellerInputs!) {\n      blacklistTraveller(blacktraveller: $passenger) {\n          name\n      }\n    }";
              _context4.next = 3;
              return graphQLFetch(query, {
                passenger: passenger
              });
            case 3:
              data = _context4.sent;
              if (data) {
                alert("Blacklisting successful");
                this.loadData();
              } else {
                alert("Sorry, Blacklisting unsuccessful.");
              }
